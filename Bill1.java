...
public class Bill1 extends JFrame implements ActionListener
{
		...
		JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,t3,t4,t5,t6;
		Button b1,b2;
		...
		Font f1=new Font("PRISTINA",Font.BOLD,18);
		...
		Bill1(int ci)
				{
					...
					int i = 0,j = 0,x=0;
					pstmt2=con.prepareStatement("select order_name,quantity,bill,total_amount from Pick_A_Pizza where cust_id=?");
					pstmt2.setInt(1,Cust_id);
						...
						pstmt3=con.prepareStatement("select sum(total_amount) from Pick_A_Pizza where cust_id=?");
						...
						pstmt4=con.prepareStatement("select sum(total_amount)*0.12 from Pick_A_Pizza where cust_id=?");
					pstmt4.setInt(1,Cust_id);
							...
							if(d1>=1000)
							{
								...
								dc=0;
								l15 = new JLabel("Congratulations....No Delivery Charge for you : ");
							...
							pstmt7=con.prepareStatement("insert into  Pick_A_Pizza_Bill (cust_id,paid_amount) values(?,?) ");
					pstmt7.setInt(1,Cust_id);
...
System.out.println("\n\nSayali...5");
						...
						if(ae.getSource()==b2)
							...
							pstmt6 =con.prepareStatement("delete from Pick_A_Pizza where cust_id=? ");

							

							pstmt5.setInt(1,Cust_id);
							pstmt6.setInt(1,Cust_id);
