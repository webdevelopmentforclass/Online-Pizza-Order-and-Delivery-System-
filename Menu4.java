...
public class Menu4 extends JFrame implements ActionListener
{

		JFrame F3 = new JFrame("Dominise");
			...
			Menu4()
				{
					...
					l[9]=new Label("\"NON-VEG SPECIAL\"");
					l[9].setBounds(575,150,400,30);
					l[9].setFont(f3);
					F3.add(l[9]);


					l[10]=new Label("Chicken Hot & Spicy");
					l[10].setBounds(550,250,180,40);
					l[10].setFont(f2);
					F3.add(l[10]);

					l[11]=new Label("Rs.315");
					l[11].setBounds(800,255,80,30);
					l[11].setFont(f2);
					F3.add(l[11]);
					

					l[12]=new Label("Chicken Kheema");
					l[12].setBounds(550,300,180,40);
					l[12].setFont(f2);
					F3.add(l[12]);

					l[13]=new Label("Rs.200");
					...
					l[28]=new Label("Corn Chicken");
					l[28].setBounds(550,350, 180,40);
					l[28].setFont(f2);
					F3.add(l[28]);

					l[29]=new Label("Rs.225");
					l[29].setBounds(800,355,80,30);
					l[29].setFont(f2);
					F3.add(l[29]);

					l[14]=new Label(" Mutton Masala");
					l[14].setBounds(550,400,180,40);
					l[14].setFont(f2);
					F3.add(l[14]);

					l[15]=new Label("Rs.350");
