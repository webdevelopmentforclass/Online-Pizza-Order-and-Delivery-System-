			...
			Menu1()
				{
					...
					l[26]=new Label("WELCOME To Pick_A_Pizza...!!!!");
					...
					l[27]=new Label("\"VEG LOVERS\" ");
					Font f3=new Font("PRISTINA",Font.BOLD,30);
					l[27].setBounds(75,200,500,30);
					l[27].setFont(f3);
					F3.add(l[27]);
					...
					l[1]=new Label("Veggie Paradie");
					l[1].setBounds(50,250, 180,40);
					l[1].setFont(f2);
					F3.add(l[1]);
					
					
					l[2]=new Label("Rs.180");
					l[2].setBounds(300,255,80,30);
					l[2].setFont(f2);
					F3.add(l[2]);
					
					
					l[3]=new Label("Farm House");
					...
					l[5]=new Label("Peppy Paneer");
					l[5].setBounds(50,350, 180,40);  
					l[5].setFont(f2);					
					F3.add(l[5]);
					

					l[6]=new Label("Rs.180");
					l[6].setBounds(300,355,80,30);
					l[6].setFont(f2);
					F3.add(l[6]);

					l[7]=new Label("Maxican-Green Wave");
					l[7].setBounds(50,400, 180,40);  
					l[7].setFont(f2);					
					F3.add(l[7]);
					

					l[8]=new Label("Rs.220");
					...
					l[9]=new Label("\"NON-VEG LOVERS\"");
					l[9].setBounds(575,200,400,30);
					l[9].setFont(f3);
					F3.add(l[9]);


					l[10]=new Label("Chicken Tikka");
					l[10].setBounds(550,250,180,40);
					l[10].setFont(f2);
					F3.add(l[10]);

					l[11]=new Label("Rs.280");
					l[11].setBounds(800,255,80,30);
					l[11].setFont(f2);
					F3.add(l[11]);
					

					l[12]=new Label("Non Veg Supreme");
					l[12].setBounds(550,300,180,40);
					l[12].setFont(f2);
					F3.add(l[12]);

					l[13]=new Label("Rs.300");
					...
					l[28]=new Label("Chicken Pepperoni");
					l[28].setBounds(550,350, 180,40);
					l[28].setFont(f2);
					F3.add(l[28]);

					l[29]=new Label("Rs.285");
					l[29].setBounds(800,355,80,30);
					l[29].setFont(f2);
					F3.add(l[29]);

					l[14]=new Label(" Peri Peri Chicken");
